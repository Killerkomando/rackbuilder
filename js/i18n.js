...
const translations = {
  en: {
    ...
    netbox_autocomplete_desc: 'Upload exported files from NetBox (JSON, YAML, or CSV) to enable autocomplete for Device Types and Roles.',
  ...
  de: {
    ...
    netbox_autocomplete_title: 'NetBox Autocomplete (Optional)',
    netbox_autocomplete_desc: 'Lade exportierte Dateien aus NetBox hoch (JSON, YAML oder CSV), um Autocomplete für Gerätetypen und Rollen zu aktivieren.',
