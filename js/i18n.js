...
const translations = {
  en: {
    ...
    netbox_autocomplete_desc: 'Upload exported JSON files from NetBox to enable autocomplete for Device Types and Roles.',
    netbox_device_types: 'Device Types',
    netbox_roles: 'Roles',
    netbox_btn_upload: 'Upload JSON',
    netbox_btn_clear: 'Clear',
    netbox_loaded: '{count} entries loaded',
    netbox_not_loaded: 'Not loaded',
    netbox_upload_invalid: 'Invalid file. Expected a JSON array with name/slug fields (or a NetBox API response with results).',
    ph_comments: '',
  },
  de: {
    app_title: 'Rack Builder',
    ...
    netbox_autocomplete_title: 'NetBox Autocomplete (Optional)',
    netbox_autocomplete_desc: 'Lade exportierte JSON-Dateien aus NetBox hoch, um Autocomplete für Gerätetypen und Rollen zu aktivieren.',
    netbox_device_types: 'Gerätetypen',
    netbox_roles: 'Rollen',
    netbox_btn_upload: 'JSON hochladen',
    netbox_btn_clear: 'Löschen',
    netbox_loaded: '{count} Einträge geladen',
    netbox_not_loaded: 'Nicht geladen',
    netbox_upload_invalid: 'Ungültige Datei. Erwartet wird ein JSON-Array mit name/slug-Feldern (oder eine NetBox-API-Antwort mit results).',
    ph_comments: '',
  },
};
